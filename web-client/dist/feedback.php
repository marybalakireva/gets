...
<html>
    <head>               
        ...
        <script src="scripts/gets/models/Feedback.Class.js"></script>
        ...
        <script src="scripts/gets/views/FeedbackMain.View.js"></script>
        ...
        <script src="scripts/gets/controllers/FeedbackPage.Ctrl.js"></script>
        ...
        <script>
            $(document).ready(function() {
                ...
                var _feedbackPageCtrl = new FeedbackPage(document, window);
                _feedbackPageCtrl.initPage();               
            });  
        </script>
        ...
        <div class="main-container">
            ...
            <div class="main-content">
                <div class="action-menu">
                    <?php
                    require_once('./widgets/FeedbackMain.inc');
